...
To keep things simple, we have chosen a very simple homogeneous subsurface model, with an idealized 
...
by \citet{Heckenbach2019a}, using an explicit solver (FTCS) for the simplified heat equation
...
any heat production is neglected. The same GSTH was also used in an iterative way to generate the 
nonequilibrium initial values for the forward models within the inverse procedure 
\citep{Rath2019a}. 
